...
<>
 ...
 <>
 <div class="w-full h-full flex justify-center items-center">
  <div class="w-full shadow-lg px-0 absolute z-50 2xl:px-3 h-full justify-center  items-center rounded-lg gap-0 xl:gap-3 dark:bg-[#21212166] bg-[#e8e8e866] flex flex-col">
 <img src="./loader.svg" ></img>
 </div>
