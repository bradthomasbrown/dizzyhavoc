...
return (
    <section class="rounded flex flex-col p-3 my-1 gap-3 mx-3">
            <h1 class="font-medium sm:text-[1.6rem] text-[1rem] flex justify-center items-center tracking-wide">Average Price
            ...
            <h2 class="font-medium sm:text-[1.6rem] text-[1rem] flex justify-center items-center tracking-wide">Market Cap
