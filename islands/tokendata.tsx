...
<div class="dropdown" id="dropdown1">
  <img src="image1.jpg" alt="Dropdown Trigger Image" onclick="toggleDropdown('dropdown1')">
...
<div class="dropdown" id="dropdown2">
  <img src="image2.jpg" alt="Dropdown Trigger Image" onclick="toggleDropdown('dropdown2')">
...
<div className="mb-2 mt-4 dark:text-[#d2d2d2] unselectable text-[10px] sm:text-[13px]">update in: {count}</div>
<div class="bottom-1 sm:visible invisible dark:text-[#d2d2d2] unselectable text-[#6e6e6e] absolute left-1 text-[7x] sm:text-[11px]">data from dexscreener, coingecko & poloniex</div>
</div>
</>
