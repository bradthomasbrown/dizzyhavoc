...
export function Arb(props: {
  ...
  tx_arb_buy: Signal<number>;
  tx_arb_sell: Signal<number>;
}) {
  const { token_arb, h24_arb, liq_arb, vol24_arb, tx_arb_buy, tx_arb_sell } = props;
  return (
          ...
          <section class="rounded  p-2 sm:p-0 flex flex-col sm:flex-row mx-auto w-full py-[1px] ml-0">
            ...
            <div class="sm:mx-2 ml-0 flex flex-row">
              <h1 class="font-[Poppins] text-[#4da235] text-[0.95rem] inline">
                {Number(formatNumber(tx_arb_buy.value)).toFixed(0)}
              </h1>
              ...
              <h1 class="sm:ml-1 ml-0 font-[Poppins] text-[#a23535] text-[0.95rem] inline">
                {Number(formatNumber(tx_arb_sell.value)).toFixed(0)}
              </h1>
              </div>
          </section>
        </div>
