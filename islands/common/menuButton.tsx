...
export default function MenuButton() {
  ...
  return (
    <>
      <div>
        <select
          class="text-2xl unselectable text-[#3d3d3d] dark:text-[#ccb286] p-0 outline-none text-center w-[120px] sm:w-[130px] shadow-lg font-[Poppins] rounded-lg border border-[#e9e9e9] dark:border-[#ffffff1f] cursor-pointer dark:bg-[#101010] bg-[#f1f1f1]"
          name="category"
