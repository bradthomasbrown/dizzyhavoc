  ...
  return (
    <>
      ...
      <div class="w-full h-full flex justify-center">
        ...
        <a><img src="/token.png" className="lg:size-[55px] lg:visible invisible hover:scale-[105%]"></img></a>
        </div>
        <img className="absolute hidden top-0 z-[-10] right-0 w-[25%]" src="/dzhv.png" alt="dizzyhavoc eye"></img>
      </div>
