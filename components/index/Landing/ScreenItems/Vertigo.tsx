export function Vertigo(){
    return(
        ...
        <a class="" draggable={false} target="_blank" href="https://beta.dzhv.io/bridge"><div class="w-[190px] h-[30px] hover:scale-[102%] active:scale-[98%] mt-2 rounded-md dark:text-[#ccb286] text-[#b37635] bg-[#ccb28611] font-[Poppins] text-lg text-center font-light tracking-tight border dark:border-[#ccb286] border-[#b37635]">Try now on testnet</div></a>
        </div>
      </div>
    )
}