export function Vertigo(){
    return(
        ...
        <img class="sm:size-[100px] ml-[1rem] sm:ml-0 mb-2 size-[70px] saturate-0 contrast-75 rounded-xl" draggable={false} src="/carousel/Vertigo.jpg" alt="dzhv chevron" />
        </div>
        ...
        <a class="" draggable={false} target="_blank" href="https://beta.dzhv.io/bridge"><div class="w-[190px] h-[30px] hover:scale-[102%] active:scale-[98%] mt-2 rounded-md text-[#ccb286] bg-[#ccb28611] font-[Poppins] text-lg text-center font-light tracking-tight border border-[#ccb286]">Try now on testnet</div></a>
        </div>
      </div>
    )
}