export function Mayhem(){
    return(
        ...
        <a class="" draggable={false} target="_blank" href="https://github.com/bradbrown-llc?tab=repositories"><div class="w-[90px] h-[30px] hover:scale-[102%] active:scale-[98%] mt-2 rounded-md text-[#ccb286] bg-[#ccb28611] font-[Poppins] text-lg text-center font-light tracking-tight border border-[#ccb286]">github</div></a>
        </div>
      </div>
    )
}