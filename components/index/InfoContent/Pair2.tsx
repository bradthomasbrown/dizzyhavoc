...
<div class="flex  flex-row p-9 sm:size-[450px] size-full dark:text-[#d2d2d2] text-[#3d3d3d] h-[100%] pb-[5.72rem] rounded-xl shadow-lg bg-blur2 sm:flex-col-reverse">
...
<div class="flex flex-row sm:mx-0 mx-auto p-4 mt-7 sm:mt-0 sm:size-[450px] size-[320px] dark:text-[#d2d2d2] text-[#3d3d3d] rounded-xl shadow-lg bg-blur2">
