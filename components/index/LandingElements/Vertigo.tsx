export default function Vertigo(){
    return(
        <div class="z-30 w-full h-full absolute items-center flex flex-row">
        <div class="flex flex-col ml-[15%]">
        <img class="size-[130px] contrast-75" draggable={false} src="/misc/dzhv-art-chevron-m.jpg" alt="dzhv chevron" />
        <p class="text-3xl dark:text-[#d2d2d2] text-[#3d3d3d] font-medium unselectable font-[Poppins]">Vertigo, a cutting-edge bridge for $DZHV.</p>
