...
// acquire node url
const url = 'https://arbitrum-sepolia.blockpi.network/v1/rpc/public'
...
const upgrade = await steps.bridgeableUpgrade({ session, create2, salt: 4n, nonce: 4n, execute: true }) // deployer bridge upgrade
await steps.updateLinks({ session, resolver, upgrade, nonce: 1n, execute: true }) // implementer bridge upgrade
